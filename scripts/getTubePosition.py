def cal(world_rob_x, world_rob_y, world_rob_theta):
    ...
    # 本当は0.1258
    world_rob_bl_tube_rot_axis_position_x = rob_rob_x - 0.125
    world_rob_bl_tube_rot_axis_position_y = rob_rob_y + 0.075
    world_rob_bl_tube_tip_position_x = rob_rob_x - 0.23
    world_rob_bl_tube_tip_position_y = rob_rob_y + 0.075
    ...
    world_bl_tube_rot_axis = np.array([world_rob_bl_tube_rot_axis_position_x, world_rob_bl_tube_rot_axis_position_y])
    world_bl_tube_tip = np.array([world_rob_bl_tube_tip_position_x, world_rob_bl_tube_tip_position_y])
    ...
    world_rob_bl_tube_rot_axis_position = np.dot(reverse_rotate, world_bl_tube_rot_axis)
    world_rob_bl_tube_tip_position = np.dot(reverse_rotate, world_bl_tube_tip)
    ...
    print("/////////////////////////////////////////////////")
    return world_rob_bl_tube_rot_axis_position, world_rob_bl_tube_tip_position,rob_br_tube_rot_axis_position,rob_br_tube_tip_position
