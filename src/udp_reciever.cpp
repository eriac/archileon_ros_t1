...
void set_robot(float *pos, float *dir){
	static tf::TransformBroadcaster br;
	tf::Transform transform;
	...
	tf::Transform transform2;//write by hand
	transform2.setOrigin(  tf::Vector3(   -0.15, 0, -0.2));//-Z -Y +X
	transform2.setRotation(tf::Quaternion(0, 0.707, 0, 0.707));
